...
export class FixAddressEntity1758338407892 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // Set any NULL descriptions to empty string before applying NOT NULL constraint
        await queryRunner.query(`UPDATE "addresses" SET "description" = '' WHERE "description" IS NULL`);
