...
export class FixAddressEntity1759015636303 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "users" ADD "cpf" character varying(11)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_affiliation_enum" AS ENUM('USER', 'CE_ADMIN', 'SERVICE_PROVIDER', 'SUPER_ADMIN', 'SERVICE_PROVIDER_MANAGER')`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "affiliation" "public"."users_affiliation_enum" NOT NULL DEFAULT 'USER'`,
    );
  }
